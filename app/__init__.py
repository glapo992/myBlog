...
#FLASK SETTINGS---------------------
app = Flask(__name__)
app.config.from_object(Config) # import configs from the Class Config in the as-named module. the values are accesseb from a dict-like statement (app.config['SECRET_KEY'])
#-----------------------------------
